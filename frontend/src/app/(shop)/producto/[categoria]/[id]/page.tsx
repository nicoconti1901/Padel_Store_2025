...
import { ProductCategory, Indumentaria, Accesorio } from "@/types/product"
...
export default async function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  const product = await productService.getProductById(id, categoria)
  ...
  // Type guards
  const isIndumentaria = (p: typeof product): p is Indumentaria => p.categoria === 'indumentaria';
  const isAccesorio = (p: typeof product): p is Accesorio => p.categoria === 'accesorios';
